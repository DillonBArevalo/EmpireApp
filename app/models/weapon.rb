class Weapon < ApplicationRecord
  ...
  has_many :weapon_classes_weapons, dependent: :delete_all
  ...
  has_many :attack_options, dependent: :delete_all
  ...
  has_many :equipped_weapons, dependent: :delete_all
  has_many :characters, through: :equipped_weapons

  has_many :obtained_weapons, dependent: :delete_all
  has_many :inventories, through: :obtained_weapons

  validates :user, :weapon_type, :name, :description, :defense_die_number, :defense_die_size, :flat_defense_bonus, :defense_energy_modifier, :extra_block_cost, :hands_used, presence: true
