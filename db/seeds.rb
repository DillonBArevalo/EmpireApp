...
AttackOption.create!(name: 'Shield Bash', description: 'A sharp push or controlled swing with the flat of a shield meant to throw someone off balance', description: "If in closed in (in same square as target), add 2dSTR and any victory pushes them one square away in the direction you face. Successful attacks also give the following conditions: Narrow: 25 percent reduction of opponent’s next attack energy, Clear: 50 percent reduction, Strong: Attacker is Off Balance, Overwhelming: Attacker is Prone.", weapon_id: light_shield.id, damage_type_id: bludgeoning.id, energy_modifier: 1.5, die_number: 1, die_size: 4, attack_bonus: 10, damage_dice: 0, damage_die_size: 0)
...
AttackOption.create!(name: 'Shield Bash', description: 'A heavy thrust forward with the flat of the shield that presents a fast moving wall to your opponent. Good luck staying on your feet when this hits you.', description: "If in closed in (in same square as target), add 2dSTR and any victory pushes them one square away in the direction you face. Successful attacks also give the following conditions: Narrow: 25 percent reduction of opponent’s next attack energy, Clear: 50 percent reduction, Strong: Attacker is Off Balance, Overwhelming: Attacker is Prone.", weapon_id: heavy_shield.id, damage_type_id: bludgeoning.id, energy_modifier: 1, die_number: 1, die_size: 6, attack_bonus: 15, damage_dice: 0, damage_die_size: 0)
