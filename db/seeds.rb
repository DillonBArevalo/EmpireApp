...
# Characters
Character.create!(user_id: core_user.id, name: 'Display Character', description: 'A character with a generic stat line to show off equipment', strength: 12, dexterity: 12, constitution: 12, intelligence: 12, wisdom: 12, charisma: 12)
